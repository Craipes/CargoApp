...
public class CarRequest : BaseRequest
{
    ...
    [Display(Name = "Early departure time")][DisplayFormat(DataFormatString = "{0:D}")][CorrectDepartureDate] public DateTime EarlyDepartureDate { get; set; }
    [Display(Name = "Late departure time")][DisplayFormat(DataFormatString = "{0:D}")][CorrectDepartureDate][LaterThan(nameof(EarlyDepartureDate))] public DateTime LateDepartureDate { get; set; }
