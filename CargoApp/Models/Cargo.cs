...
public class Cargo
{
    ...
    [Display(Name = "Mass")][Column(TypeName = "decimal(8, 3)")][Range(0.001, 100000, MaximumIsExclusive = true, ErrorMessage = "Range Error")][Required(ErrorMessage = "Required Error")] public float Mass { get; set; }
    ...
    [Display(Name = "Description")][MaxLength(512)] public string? Description { get; set; }
}
