...
namespace CargoApp.Migrations
{
    ...
    [Migration("20241020080914_RemovedSettlements")]
    partial class RemovedSettlements
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("CargoApp.Models.Cargo", b =>
                {
                    ...
                    b.Property<int?>("CargoResponseCargoId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("CargoResponseCargoId")
                        .IsUnique()
            ...
            modelBuilder.Entity("CargoApp.Models.CargoRequest", b =>
                {
                    b.HasOne("CargoApp.Models.Car", "Car")
                        .WithOne()
                        .HasForeignKey("CargoApp.Models.CargoRequest", "CarId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
