...
namespace CargoApp.Migrations
{
    ...
    [Migration("20220130173023_SettlementsInRequests")]
    partial class SettlementsInRequests
    {
            ...
            modelBuilder.Entity("ApplicationCore.Entities.CargoRequest", b =>
                {
                    ...
                    b.HasOne("ApplicationCore.Entities.Settlement", "DeparturePlace")
                        .WithMany()
                        .HasForeignKey("DeparturePlaceId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();

                    b.HasOne("ApplicationCore.Entities.Settlement", "DestinationPlace")
                        .WithMany()
